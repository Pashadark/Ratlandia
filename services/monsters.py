"""Монстры для режима Туннели — 20+ врагов с прогрессией и дропом"""
...
TUNNEL_MONSTERS = {
    ...
    "blind_mole": {
        "name": "Слепой Крот", "level": 1, "rarity": "common",
        "health": 8, "min_damage": 1, "max_damage": 2,
        "base_crumbs": 15, "base_xp": 30,
    ...
    "giant_woodlouse": {
        "name": "Мокрица-переросток", "level": 1, "rarity": "common",
        "health": 6, "min_damage": 1, "max_damage": 3,
        "base_crumbs": 12, "base_xp": 25,
        "ability": "curl", "ability_desc": "_Сворачивается в клубок при HP < 50%_",
        "icon": "🪲",
    ...
    "earthworm": {
        "name": "Дождевой Червь", "level": 1, "rarity": "common",
        "health": 10, "min_damage": 1, "max_damage": 1,
        "base_crumbs": 18, "base_xp": 35,
        "ability": "regeneration", "ability_desc": "_Восстанавливает 1 HP каждый ход_",
        "icon": "🪱",
    ...
    "rustler": {
        "name": "Шуршун", "level": 1, "rarity": "uncommon",
        "health": 5, "min_damage": 2, "max_damage": 4,
        "base_crumbs": 25, "base_xp": 50,
        "ability": "fast", "ability_desc": "_20% шанс атаковать дважды_",
        "icon": "🐀",
    ...
    "moldling": {
        "name": "Плесневик", "level": 1, "rarity": "common",
        "health": 12, "min_damage": 0, "max_damage": 2,
        "base_crumbs": 10, "base_xp": 40,
        "ability": "spores", "ability_desc": "_30% шанс отравить на 2 хода_",
        "icon": "🍄",
    ...
    "renegade_rat": {
        "name": "Крыса-Отступница", "level": 2, "rarity": "uncommon",
        "health": 14, "min_damage": 2, "max_damage": 5,
        "base_crumbs": 40, "base_xp": 80,
        "ability": "block", "ability_desc": "_Раз в 3 хода блокирует атаку_",
        "icon": "🐀",
    ...
    "scolopendra": {
        "name": "Сколопендра Многоножка", "level": 2, "rarity": "common",
        "health": 18, "min_damage": 1, "max_damage": 3,
        "base_crumbs": 30, "base_xp": 60,
        "ability": "many_legs", "ability_desc": "_Всегда атакует дважды_",
        "icon": "🐛",
    ...
    "grinder_beetle": {
        "name": "Жук-Точильщик", "level": 2, "rarity": "uncommon",
        "health": 20, "min_damage": 2, "max_damage": 3,
        "base_crumbs": 45, "base_xp": 90,
        "ability": "hard_shell", "ability_desc": "_Каждую 3-ю атаку игнорирует_",
        "icon": "🪲",
    ...
    "giant_slug": {
        "name": "Слизень-Гигант", "level": 2, "rarity": "common",
        "health": 25, "min_damage": 1, "max_damage": 2,
        "base_crumbs": 25, "base_xp": 70,
        "ability": "slow", "ability_desc": "_При попадании замедляет на 1 ход_",
        "icon": "🐌",
    ...
    "vampire_bat": {
        "name": "Летучая Мышь-Кровосос", "level": 2, "rarity": "rare",
        "health": 12, "min_damage": 3, "max_damage": 5,
        "base_crumbs": 60, "base_xp": 120,
        "ability": "vampirism", "ability_desc": "_Восстанавливает половину урона_",
        "icon": "🦇",
    ...
    "weaver_spider": {
        "name": "Паук-Ткач", "level": 3, "rarity": "uncommon",
        "health": 30, "min_damage": 3, "max_damage": 6,
        "base_crumbs": 75, "base_xp": 140,
        "ability": "web", "ability_desc": "_Раз в 3 хода опутывает паутиной_",
        "icon": "🕷️",
    ...
    "armadillo_centipede": {
        "name": "Сороконожка-Броненосец", "level": 3, "rarity": "uncommon",
        "health": 35, "min_damage": 2, "max_damage": 4,
        "base_crumbs": 65, "base_xp": 130,
        "ability": "curl_ball", "ability_desc": "_При HP < 30% сворачивается в шар_",
        "icon": "🪱",
    ...
    "rat_ghoul": {
        "name": "Крысиный Упырь", "level": 3, "rarity": "rare",
        "health": 28, "min_damage": 4, "max_damage": 7,
        "base_crumbs": 100, "base_xp": 200,
        "ability": "frenzy", "ability_desc": "_При HP < 50% впадает в ярость_",
        "icon": "🐀💀",
    ...
    "giant_cockroach": {
        "name": "Подземный Таракан-Гигант", "level": 3, "rarity": "common",
        "health": 22, "min_damage": 1, "max_damage": 8,
        "base_crumbs": 50, "base_xp": 100,
        "ability": "survival", "ability_desc": "_50% шанс при смерти восстановить HP_",
        "icon": "🪳",
    ...
    "sewer_leech": {
        "name": "Пиявка Сточная", "level": 3, "rarity": "uncommon",
        "health": 40, "min_damage": 1, "max_damage": 3,
        "base_crumbs": 70, "base_xp": 150,
        "ability": "attach", "ability_desc": "_Присасывается к туловищу_",
        "icon": "🪱🩸",
    ...
    "black_ferret": {
        "name": "Чёрный Хорёк", "level": 4, "rarity": "rare",
        "health": 45, "min_damage": 5, "max_damage": 8,
        "base_crumbs": 120, "base_xp": 300,
        "ability": "hypnosis", "ability_desc": "_Раз в 4 хода гипнотизирует_",
        "icon": "🦡",
    ...
    "two_headed_rat": {
        "name": "Крыса-Мутант с Двумя Головами", "level": 4, "rarity": "epic",
        "health": 60, "min_damage": 4, "max_damage": 8,
        "base_crumbs": 175, "base_xp": 500,
        "ability": "two_heads", "ability_desc": "_Всегда атакует дважды_",
        "icon": "🐀🐀",
    ...
    "basement_snake": {
        "name": "Подвальный Уж", "level": 4, "rarity": "rare",
        "health": 35, "min_damage": 4, "max_damage": 9,
        "base_crumbs": 140, "base_xp": 360,
        "ability": "constrict", "ability_desc": "_40% шанс обвить при атаке_",
        "icon": "🐍",
    ...
    # ===== ЭЛИТНЫЕ =====
    "elite_mole_king": {
        "name": "Король Кротов", "level": 3, "rarity": "elite",
        "health": 50, "min_damage": 5, "max_damage": 10,
        "base_crumbs": 200, "base_xp": 400,
        "ability": "summon", "ability_desc": "_Призывает кротов-помощников_",
        "icon": "👑🦔",
    ...
    "elite_spider_queen": {
        "name": "Королева Пауков", "level": 4, "rarity": "elite",
        "health": 80, "min_damage": 6, "max_damage": 12,
        "base_crumbs": 300, "base_xp": 700,
        "ability": "summon_spiders", "ability_desc": "_Призывает пауков каждые 3 хода_",
        "icon": "👑🕷️",
    ...
    # ===== БОСС =====
    "old_blind_cat": {
        "name": "Старый Слепой Кот", "level": 5, "rarity": "boss",
        "health": 100, "min_damage": 8, "max_damage": 15,
        "base_crumbs": 650, "base_xp": 800,
        "ability": "multiple", "ability_desc": "_Восстанавливает HP, оглушает, иммунитет к хвосту_",
        "icon": "🐈",
...
def calculate_monster_stats(monster: Dict, room_number: int, player_level: int = 1, kill_streak: int = 0) -> Dict:
    """Рассчитывает характеристики монстра с учётом комнаты, уровня игрока и серии убийств"""
    ...
    rarity_mods = {"common": 1.0, "uncommon": 1.5, "rare": 2.5, "epic": 4.0, "elite": 6.0, "boss": 10.0}
...
def process_loot(monster_id: str, room_number: int = 1, kill_streak: int = 0) -> Dict:
    ...
    multiplier = loot_table.get("crumbs", {}).get("multiplier", 1.0)
    room_bonus = 1.0 + (room_number * 0.1)
    streak_bonus = 1.0 + (min(10, kill_streak) * 0.05)
    total_crumbs = int(base_crumbs * multiplier * room_bonus * streak_bonus)
    loot["crumbs"] = random.randint(int(total_crumbs * 0.8), int(total_crumbs * 1.2))

    for resource_data in loot_table.get("resources", []):
        if random.randint(1, 100) <= resource_data.get("chance", 10):
            loot["resources"].append(resource_data["item_id"])

    rarity_multipliers = {"common": 0.5, "uncommon": 0.4, "rare": 0.3, "epic": 0.2, "elite": 1.0, "boss": 1.0}
    drop_multiplier = rarity_multipliers.get(monster.get("rarity", "common"), 0.5)
    streak_bonus_chance = min(15, kill_streak * 1)

    for item_data in loot_table.get("items", []):
        chance = max(1, int(item_data.get("chance", 0) * drop_multiplier))
        if random.randint(1, 100) <= chance + streak_bonus_chance:
...
def process_boss_loot(boss_id: str) -> List[str]:
    """Обрабатывает дроп с босса (гарантированные предметы)"""
